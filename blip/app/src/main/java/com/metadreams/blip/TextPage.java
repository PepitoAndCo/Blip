...
public class TextPage extends AppCompatActivity {
    ...
    // ================================================
    private String webAdress = "http://196.168.56.1:2000/send_text?id"+ Userid + "&type=" + Acctype;
    // ================================================
    ...
    String date2bstored = "";
    String RetreivedLatestPOST;
    long RetreivedLatestPOSTlong;
...
//---when the SMS has been delivered---
    ...
    public void TestHTTPLatest(View view){
        ReturnLatestPOSTValue();

        System.out.println("RetreivedLatestPOST = " + RetreivedLatestPOST);
...
*/
    ...
    private void SetLatestPostDate(){
        ...
        //SharedPreferences shared = getSharedPreferences(LatestsPostFile, 0);
        //String RetreivedLatestPOST = (shared.getString(date2bstored, ""));
    ...
    private void ReturnLatestPOSTValue(){
        SharedPreferences shared = getSharedPreferences(LatestsPostFile, 0);
        RetreivedLatestPOST = (shared.getString(date2bstored, ""));

        RetreivedLatestPOSTlong = Long.parseLong(RetreivedLatestPOST);
    }
}